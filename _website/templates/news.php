                        ...
                        <div class="list-event-item">
                            <div class="box-content-inner clearfix">
                                ...
                                <div class="list-event-header">
                                    ...
                                    <div class="view-details"><a href="<?php echo $link;?>" class="lightBtn" target="_blank"><?php echo l('more');?></a></div>
                                </div>
                                <h5 class="event-title"><a href="<?php echo $link;?>" target="_blank"><?php echo $item['title'];?>; &nbsp;<?php echo $item['menutitle'];?></a></h5>
                                <p><?php echo $item['description'];?></p>
                            </div> <!-- /.box-content-inner -->
                        </div> <!-- /.list-event-item -->
<?php } ?>
